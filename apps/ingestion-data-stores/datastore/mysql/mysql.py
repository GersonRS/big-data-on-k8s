...
class MySQL(object):
    ...
    def insert_rows():
        ...
        pd_df_commerce.to_sql(
            "commerce", mysql_engine, if_exists="append", index=False, chunksize=100
        )
        pd_df_computer.to_sql(
            "computer", mysql_engine, if_exists="append", index=False, chunksize=100
        )
        pd_df_device.to_sql(
            "device", mysql_engine, if_exists="append", index=False, chunksize=100
        )
