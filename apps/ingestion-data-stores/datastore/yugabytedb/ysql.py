...
class YSQL(object):
    ...
    def insert_rows():
        ...
        pd_df_user.to_sql(
            "user", ysql_engine, if_exists="append", index=False, chunksize=100
        )
        pd_df_subscription.to_sql(
            "subscription", ysql_engine, if_exists="append", index=False, chunksize=100
        )
        pd_df_device.to_sql(
            "device", ysql_engine, if_exists="append", index=False, chunksize=100
        )
